...
@Tag(
        name = "CURD REST APIs for Cards in EasyBank",
        description = "CURD REST APIs for Cards in EasyBank"
)
public class CardsController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ResponseDto> createCard(@Valid @RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number is not valid") String mobileNumber) {
    ...
    @Operation(
            ...
            description = "Rest api to fetch Card details inside EasyBank"
    )
    @ApiResponses(
            {
    ...
    public ResponseEntity<CardsDto> fetchCardDetails(
            @Valid @RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number is not valid") String mobileNumber) {
    ...
    public ResponseEntity<ResponseDto> deleteCardDetails(@Valid @RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number is not valid") String mobileNumber) {
